...
impl Frame<'static> {
    ...
    pub fn from_rgba_speed(width: u16, height: u16, pixels: &mut [u8], speed: i32) -> Self {
        ...
        // Content-routed quantization: exact palette for ≤256 unique colors,
        // NeuQuant on a routed training stream otherwise. See `quantize.rs`.
        crate::quantize::quantize_frame(width, height, pixels, speed, transparent)
    }
